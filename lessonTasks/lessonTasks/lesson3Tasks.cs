...
namespace lessonTasks
{
    ...
    public class lesson3Tasks
    {
        ...
        public class Fraction
        {
            ...
            public int intPart;         //Дополнительно объявляем параметр, обозначающий целую часть дроби (for example: две целых четыре пятых
            ...
            public int IntPart          //Свойство для чтения целой части числа
            {
